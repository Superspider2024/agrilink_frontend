          ...
          <form className="mt-8 space-y-6" onSubmit={handleSignup}>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button type="button" onClick={() => setUserType('farmer')} className={`w-full py-3 px-4 border rounded-md text-sm font-medium focus:outline-none ${userType === 'farmer' ? 'bg-green-100 border-green-500 text-green-700' : 'border-gray-300 text-gray-500 hover:bg-gray-100'}`}>Farmer</button>
                <button type="button" onClick={() => setUserType('buyer')} className={`w-full py-3 px-4 border rounded-md text-sm font-medium focus:outline-none ${userType === 'buyer' ? 'bg-green-100 border-green-500 text-green-700' : 'border-gray-300 text-gray-500 hover:bg-gray-100'}`}>Buyer</button>
              </div>
            </div>
            {/* Form Inputs */}
            <div className="rounded-md shadow-sm space-y-4">
              ...
              <input name="location" type="text" required className="appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm" placeholder="Your City/Town" value={location} onChange={(e) => setLocation(e.target.value)} />
